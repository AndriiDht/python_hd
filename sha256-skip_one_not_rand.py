...
def sha256(word, trs_file):
    ...
    one_trace = []
    for i in range(64):
        a, b, c, d, e, f, g, h, hamming_distance = do_round(a, b, c, d, e, f, g, h, K[i], word[i], bool(i % 2))
        if i % 2 == 0:
...
if __name__ == "__main__":
    ...
    # do_tests()
    with trs_open('sha256_hd_skip_not_rand.trs', 'w', engine='TrsEngine', padding_mode=TracePadding.AUTO, live_update=True) as trs_file:
